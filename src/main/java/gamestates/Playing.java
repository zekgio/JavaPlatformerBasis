...
public class Playing extends State implements Statemethods {
	...
	private boolean isSpaceKeyActive = true;

	private int xLvlOffset, yLvlOffset;
	private final int leftBorder   = (int) (0.49 * Game.GAME_WIDTH);
	private final int rightBorder  = (int) (0.51 * Game.GAME_WIDTH);
	private final int topBorder    = (int) (0.35 * Game.GAME_HEIGHT);
	private final int bottomBorder = (int) (0.65 * Game.GAME_HEIGHT);
	...
	public Playing(Game game) {
		...
		for (int i = 0; i < smallCloudsPos.length; i++)
			smallCloudsPos[i] = (int) (190 * Game.SCALE) + rnd.nextInt((int) (100 * Game.SCALE));
	...
	private void checkCloseToBorder() {
		...
		if (diffY > bottomBorder)    yLvlOffset += diffY - bottomBorder;
		else if (diffY < topBorder)  yLvlOffset += diffY - topBorder;
			...
			switch (e.getKeyCode()) {
				...
				case KeyEvent.VK_SPACE:
					if(isSpaceKeyActive) {
						...
						if(!player.isJump() && !player.isInAir()) {
							player.setJump(true);
							break;
						}
